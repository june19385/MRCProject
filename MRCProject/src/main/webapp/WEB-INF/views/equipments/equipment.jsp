	...
	<div id="page-wrapper">
		...
		<div id="header">
			...
			<ul>
				...
				<li><a href="left-sidebar.html">설비 현황</a>
					<ul>
						<li class="current"><a href="equipment">조립 교정</a></li>
						<li><a href="standard">기준기</a></li>
		...
		<div class="container">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">조립교정</li>
			</ol>
			...
			<div class="row">
				...
				<div class="col-lg-3 mb-4">
					<div class="list-group">
						<a href="equipment" class="list-group-item active">조립교정</a> 
						<a href="standard" class="list-group-item">기준기</a>
