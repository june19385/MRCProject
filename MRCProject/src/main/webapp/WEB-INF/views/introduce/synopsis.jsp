				...
				<div class="col-lg-3 mb-4">
					<div class="list-group">
						<a href="index.html" class="list-group-item">인사말</a> <a
							...
							href="services.html" class="list-group-item">회사 연혁</a> <a
							href="contact.html" class="list-group-item">목표</a> <a
							href="portfolio-1-col.html" class="list-group-item">조직도</a>
					</div>
				</div>
				<!-- Content Column -->
