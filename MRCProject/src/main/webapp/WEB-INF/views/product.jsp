	...
	<div id="page-wrapper">
		...
		<div id="header">
			...
			<ul>
				...
				<li class="current"><a href="product.html">제품 소개</a>
					<ul>
				...
				<div class="row">
					...
					<div class="col-lg-3 mb-4">
						<div class="list-group">
							<a class="list-group-item">제품1</a> <a
								class="list-group-item">제품2</a> <a
								class="list-group-item active">제품3</a> <a
        ...
        <div class="col-md-7">
          <a href="#">
            <img class="img-fluid rounded mb-3 mb-md-0" alt="" src="http://placehold.it/700x300">
          </a>
        </div>
        <div class="col-md-5">
          <h3>Project One</h3>
